...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // You need to adopt a FUIAuthDelegate protocall to receive callback
        ...
        spots.spotArray.append(Spot(name: "Pino's", address: "Cleveland Circle", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
